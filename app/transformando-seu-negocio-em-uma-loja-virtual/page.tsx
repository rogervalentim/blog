...
export default function TransformandoSeuNegocioEmUmaLojaVirtual() {
  return (
    <>
      <Header />
      <section className="px-[22px] lg:px-[200px] pb-[136px]">
        ...
        <div className="flex gap-[23.5px]">
          <article className="rounded-xl bg-[#14161A] border border-[#20242C] w-full  opacity-100">
            <Image
              src={
                "/blog/big/transformando-seu-negocio-em-uma-loja-virtual.png"
              }
              alt="Transformando seu negócio em uma loja virtual"
              width={719}
              height={264}
              ...
              <div className="pt-12 flex flex-col gap-8">
                ...
                <ul className="list-disc flex flex-col gap-0.5 ml-5">
                  <li className="text-[#D3D5D9] font-regular text-sm">
                    <strong>Loja responsiva:</strong> Sua loja estará otimizada
                    para todos os dispositivos, garantindo uma experiência de
                    compra perfeita em qualquer tela.
                  </li>
                  <li className="text-[#D3D5D9] font-regular text-sm">
                    <strong>Gestão de inventário:</strong>
                    Organize seus produtos com facilidade e mantenha o controle
                    sobre o estoque de sua loja.
                  </li>
                  <li className="text-[#D3D5D9] font-regular text-sm">
                    <strong>Formas de pagamento:</strong> Aceite pagamentos de
                    forma rápida e segura com várias opções de gateways de
                    pagamento.
                  </li>
                  <li className="text-[#D3D5D9] font-regular text-sm">
                    <strong>SEO e Marketing:</strong> Nossa plataforma já vem
                    com ferramentas de SEO integradas para ajudar sua loja a ser
                    encontrada mais facilmente nos motores de busca.
                  </li>
                  <li className="text-[#D3D5D9] font-regular text-sm">
                    <strong>Suporte especializado:</strong> Nossa equipe de
                    suporte está sempre disponível para ajudar você com qualquer
                    dúvida ou desafio.
                  </li>
                </ul>

                <p className="text-sm font-regular text-[#D3D5D9]">
                  Está pronto para colocar seus produtos no mundo? Com o
                  Site.Set, criar sua loja online é rápido, simples e acessível.
                  Desde a configuração do site até a finalização da compra,
                  oferecemos todas as ferramentas necessárias para você vender
                  com sucesso.
                </p>
              </div>
            </div>
