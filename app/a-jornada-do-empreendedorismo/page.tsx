...
export default function AJornadaDoEmpreendedorismo() {
  return (
    <>
      <Header />
            ...
            <div className="px-6 lg:px-16 pt-12 pb-16">
              ...
              <div className="pt-12 flex flex-col gap-8">
                <p className="text-sm font-regular text-[#D3D5D9]">
                  A jornada do empreendedorismo começa com uma ideia e a vontade
                  de transformá-la em algo real. No caminho, surgem desafios,
                  aprendizados e decisões importantes que moldam o crescimento
                  do seu negócio.
                </p>

                <p className="text-sm font-regular text-[#D3D5D9]">
                  Empreender exige planejamento, adaptação e as ferramentas
                  certas para evoluir. Ter uma presença online se torna
                  essencial para alcançar novos clientes, validar produtos e
                  construir uma marca forte no mercado digital.
                </p>

                <p className="text-sm font-regular text-[#D3D5D9]">
                  Cada etapa — do primeiro produto à primeira venda — faz parte
                  desse processo. Com uma loja online, você ganha autonomia,
                  controle e flexibilidade para crescer no seu ritmo e tomar
                  decisões baseadas em dados reais.
                </p>

                <p className="text-sm font-regular text-[#D3D5D9]">
                  Com o Site.Set, você conta com uma plataforma que acompanha
                  sua jornada, oferecendo simplicidade, profissionalismo e
                  suporte para transformar sua ideia em um negócio de sucesso.
                </p>
              </div>
            </div>
          </article>
